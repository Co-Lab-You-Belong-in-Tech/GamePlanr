  ...
  const undoResponse = (gameId) => {
    ...
    const isGoing =
      ...
      games.find(
        (game) =>
          game.gameId === gameId &&
          game.AttendingUsers.includes(userProfile.userID)
      );
        ...
        <main className="home-main">
          ...
          {games &&
            games.map((game, index) => (
              <div
                key={index}
                className="gameplanr-container action-buttons mt-2"
              >
                    ...
                    {responded ? (
                      <div className="col-3">
                        <img
                          ...
                          onClick={() => undoResponse(game.gameId)}
                        />
                        <p className="fs-4">
                          {getPlayersAttendingDisplay(game)}
                        </p>
                      </div>
                    ) : (
                      <div className="col-3">
